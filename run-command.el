          ...
          (cond
           ((or (run-command--experiment--active-p
                ...
                (run-command--experiment--active-p
                 'vterm-run-method))
            (run-command--run-vterm command-line buffer-base-name working-directory))
           ((eq run-command-run-method 'compile)
            (run-command--run-compile command-line buffer-base-name working-directory))
           ((eq run-command-run-method 'term)
            (run-command--run-term command-line buffer-base-name working-directory)))
...
(defun run-command--run-compile (command-line buffer-base-name working-directory)
...
(defun run-command--run-term (command-line buffer-base-name working-directory)
...
(defun run-command--run-vterm (command-line buffer-base-name working-directory)
